...
const LABELS: Record<string, Labels> = {
  ar: {
    ...
    quantity: 'الوحدات المعتمدة', sourceNotice: 'يُحتسب المستحق وفق الاتفاق والوحدات المعتمدة. الحصص أو الساعات المجدولة لا تُعتبر مستحقة تلقائيًا.',
    ...
    teacherNotice: 'للأستاذ: الإسنادات والحمل معلومات مساعدة فقط؛ الاستحقاق المتغير يعتمد الوحدات المعتمدة فعليًا.',
    contractRef: 'مرجع العقد', rate: 'السعر', currentPeriod: 'المستحق الحالي', recentPeriods: 'الفترات الأخيرة',
  },
  fr: {
    title: 'Rémunération', subtitle: 'Accord financier et droits mensuels de ce membre du personnel.', agreement: 'Accord actuel', noAgreement: 'Aucun accord financier actif.', method: 'Mode de calcul', effectiveFrom: 'Début', effectiveTo: 'Fin', amount: 'Montant', variableMethod: 'Mode variable', variableRate: 'Taux variable', notes: 'Notes', saveAgreement: 'Enregistrer', history: 'Historique des accords', periods: 'Droits mensuels', noPeriods: 'Aucune période.', newPeriod: 'Nouvelle période', start: 'Du', end: 'Au', createPeriod: 'Créer', calculate: 'Calculer', review: 'Réviser', approve: 'Approuver', quantity: 'Unités validées', sourceNotice: 'Le montant est calculé selon l’accord et les unités validées. Le planning ne vaut pas droit automatique au paiement.', current: 'Actuel', net: 'Net', gross: 'Brut', deductions: 'Retenues', allowances: 'Indemnités', bonuses: 'Primes', base: 'Base', variable: 'Variable', state: 'État', paymentBoundary: 'Après approbation, le montant dû passe au service financier. Aucun paiement caisse/banque ici.', pendingFinance: 'En attente du service financier', loading: 'Chargement…', forbidden: 'Vous n’avez pas accès aux rémunérations.', retry: 'Réessayer', agreementCreated: 'Accord créé.', periodCreated: 'Période créée.', calculated: 'Calcul terminé.', reviewed: 'Période révisée.', approved: 'Période approuvée.', teacherNotice: 'Pour un enseignant, les affectations restent informatives jusqu’à validation effective des unités.', contractRef: 'Référence contrat', rate: 'Taux', currentPeriod: 'Période actuelle', recentPeriods: 'Périodes récentes',
  },
  en: {
    title: 'Compensation', subtitle: 'Financial agreement and monthly entitlements for this staff member.', agreement: 'Current agreement', noAgreement: 'No active financial agreement.', method: 'Method', effectiveFrom: 'Effective from', effectiveTo: 'Effective to', amount: 'Amount', variableMethod: 'Variable method', variableRate: 'Variable rate', notes: 'Notes', saveAgreement: 'Save agreement', history: 'Agreement history', periods: 'Monthly entitlements', noPeriods: 'No compensation periods yet.', newPeriod: 'Create monthly entitlement', start: 'From', end: 'To', createPeriod: 'Create period', calculate: 'Calculate', review: 'Review', approve: 'Approve', quantity: 'Validated units', sourceNotice: 'The entitlement is calculated from the approved agreement and validated units. Scheduled work is not automatically payable.', current: 'Current', net: 'Net', gross: 'Gross', deductions: 'Deductions', allowances: 'Allowances', bonuses: 'Bonuses', base: 'Base', variable: 'Variable', state: 'State', paymentBoundary: 'After approval, the amount due is handed to the finance team; this screen does not execute cash or bank payment.', pendingFinance: 'Pending finance review', loading: 'Loading…', forbidden: 'You do not have access to staff compensation.', retry: 'Retry', agreementCreated: 'Agreement created.', periodCreated: 'Period created.', calculated: 'Period calculated.', reviewed: 'Period reviewed.', approved: 'Period approved.', teacherNotice: 'Teacher assignments and workload remain informational until the payable units are validated.', contractRef: 'Contract reference', rate: 'Rate', currentPeriod: 'Current entitlement', recentPeriods: 'Recent periods',
  },
  es: {
    title: 'Compensación', subtitle: 'Acuerdo financiero y derechos mensuales del personal.', agreement: 'Acuerdo actual', noAgreement: 'No hay acuerdo activo.', method: 'Método', effectiveFrom: 'Desde', effectiveTo: 'Hasta', amount: 'Importe', variableMethod: 'Método variable', variableRate: 'Tarifa variable', notes: 'Notas', saveAgreement: 'Guardar', history: 'Historial', periods: 'Derechos mensuales', noPeriods: 'No hay períodos.', newPeriod: 'Nuevo período', start: 'Desde', end: 'Hasta', createPeriod: 'Crear', calculate: 'Calcular', review: 'Revisar', approve: 'Aprobar', quantity: 'Unidades validadas', sourceNotice: 'El importe se calcula según el acuerdo y las unidades validadas. Lo programado no genera derecho automático al pago.', current: 'Actual', net: 'Neto', gross: 'Bruto', deductions: 'Deducciones', allowances: 'Complementos', bonuses: 'Bonos', base: 'Base', variable: 'Variable', state: 'Estado', paymentBoundary: 'Tras la aprobación, el importe pasa al área financiera. Aquí no se realizan pagos por caja o banco.', pendingFinance: 'Pendiente del área financiera', loading: 'Cargando…', forbidden: 'No tiene acceso a las remuneraciones.', retry: 'Reintentar', agreementCreated: 'Acuerdo creado.', periodCreated: 'Período creado.', calculated: 'Período calculado.', reviewed: 'Período revisado.', approved: 'Período aprobado.', teacherNotice: 'Las asignaciones docentes son informativas hasta validar efectivamente las unidades.', contractRef: 'Referencia', rate: 'Tarifa', currentPeriod: 'Período actual', recentPeriods: 'Períodos recientes',
  },
};
  ...
  return (
    <div className="staff-compensation">
      <div className="staff-compensation__hero">
        <div>
          <span className="staff-compensation__eyebrow">{l.title}</span>
          <h2>{l.title}</h2>
          <p>{l.subtitle}</p>
        </div>
