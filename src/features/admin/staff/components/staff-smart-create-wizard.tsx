  ...
  function handleExistingPersonSelect(person: StaffPersonCandidate) {
    setForm((current) => ({
      ...
      person: {
        ...
        name: normalizeStaffPersonCandidateText(person.name),
        name_ar: normalizeStaffPersonCandidateText(person.name_ar),
        name_fr: normalizeStaffPersonCandidateText(person.name_fr),
        account_activation_language: '',
        phone: normalizeStaffPersonCandidateText(person.phone),
        email: normalizeStaffPersonCandidateText(person.email),
      },
