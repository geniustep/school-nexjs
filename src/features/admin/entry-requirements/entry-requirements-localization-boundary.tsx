...
const FR: Record<string, string> = {
  ...
  'كتاب أو دفتر واحد مع أغلفته.': 'Un livre ou un cahier avec ses couvertures.',
  'إغلاق': 'Fermer',
  'النوع': 'Type',
  'الكمية': 'Quantité',
  'المادة': 'Matière',
  ...
  'حفظ وإضافة دفتر آخر': 'Enregistrer et ajouter un autre cahier',
  'تمت إضافة الدفتر. يمكنك الآن إضافة دفتر آخر للمادة نفسها.': 'Le cahier a été ajouté. Vous pouvez maintenant ajouter un autre cahier pour la même matière.',
  'أدخل عددًا صحيحًا لا يقل عن 1.': 'Saisissez un nombre entier supérieur ou égal à 1.',
  'أدخل كمية أكبر من صفر.': 'Saisissez une quantité supérieure à zéro.',
  'اختر المادة المرتبطة بهذا العنصر.': 'Sélectionnez la matière associée à cet article.',
  'اختر المقرر المعتمد.': 'Sélectionnez le manuel homologué.',
  'أدخل اسم العنصر.': 'Saisissez le nom de l’article.',
  'اختر لون الغلاف.': 'Choisissez la couleur de la couverture.',
  'أدخل كمية صحيحة أكبر من صفر.': 'Saisissez une quantité entière supérieure à zéro.',
...
const PATTERNS: Array<[RegExp, (...parts: string[]) => string]> = [
  ...
  [/^مجموع الأغلفة\s+(\d+(?:\.\d+)?)[،,]\s*بينما كمية العنصر\s+(\d+(?:\.\d+)?)\.\s*خفّض كميات الأغلفة\.$/u, (_all, total, quantity) => `Le total des couvertures est ${total}, alors que la quantité de l’article est ${quantity}. Réduisez les quantités de couvertures.`],
  [/^اللون «(.+)» مكرر\.$/u, (_all, color) => `La couleur « ${FR[color] ?? color} » est dupliquée.`],
