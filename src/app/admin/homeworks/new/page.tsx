...
const COPY = {
  ar: {
    title: 'إضافة واجب',
    subtitle: 'حدد الأقسام والمادة، اكتب الواجب، ثم راجع الاختيارات قبل إنشاء المسودة.',
    back: 'العودة إلى الواجبات',
    audience: 'الأقسام المستهدفة',
    ...
    sections: 'الأقسام',
    sectionsHint: 'اختر الأقسام التي سيُنشأ لها الواجب. يمكنك اختيار قسمين أو أكثر بشكل مستقل.',
    ...
    visibleStudent: 'السماح بظهوره للتلميذ بعد النشر',
    visibleParent: 'السماح بظهوره لولي الأمر بعد اكتمال النشر',
    requireSubmission: 'يتطلب تسليمًا من التلميذ',
    preview: 'الأقسام والأساتذة',
    previewHint: 'يجب أن يكون لكل قسم أستاذ رئيسي واحد للمادة قبل إنشاء الواجب.',
    teacherReady: 'جاهز',
    ...
    fixAssignments: 'أكمل إسنادات الأساتذة قبل إنشاء الواجب.',
    invalidForm: 'تحقق من بيانات الواجب قبل الإنشاء.',
    notSelected: 'لم يُحدد بعد',
    selectedSections: 'الأقسام المستهدفة',
    readyTeachers: 'الأساتذة الجاهزون',
    readyToSend: 'الواجب جاهز للإنشاء.',
    completeRequired: 'أكمل الحقول المطلوبة وإسنادات الأساتذة لتفعيل الإنشاء.',
    stepOne: '1',
    stepTwo: '2',
  },
  fr: {
    title: 'Ajouter un devoir',
    subtitle: 'Choisissez les classes et la matière, rédigez le devoir puis vérifiez les choix avant de créer le brouillon.',
    back: 'Retour aux devoirs',
    audience: 'Classes ciblées',
    ...
    sections: 'Classes',
    sectionsHint: 'Sélectionnez librement une ou plusieurs classes pour lesquelles le devoir sera créé.',
    ...
    summary: 'Résumé du devoir',
    visibility: 'Visibilité et remise',
    visibleStudent: "Autoriser l'affichage à l'élève après publication",
    visibleParent: "Autoriser l'affichage au parent après publication complète",
    requireSubmission: "Remise de l'élève requise",
    preview: 'Classes et enseignants',
    previewHint: 'Chaque classe doit avoir exactement un enseignant principal pour la matière avant la création.',
    teacherReady: 'Prêt',
    ...
    fixAssignments: 'Complétez les affectations des enseignants avant de créer le devoir.',
    invalidForm: 'Vérifiez les données du devoir avant la création.',
    notSelected: 'Non défini',
    selectedSections: 'Classes ciblées',
    readyTeachers: 'Enseignants prêts',
    readyToSend: 'Le devoir est prêt à être créé.',
    completeRequired: 'Complétez les champs requis et les affectations pour activer la création.',
    stepOne: '1',
    stepTwo: '2',
  },
  en: {
    title: 'Add homework',
    subtitle: 'Choose the classes and subject, write the homework, then review the choices before creating the draft.',
    back: 'Back to homework',
    audience: 'Target classes',
    ...
    sections: 'Classes',
    sectionsHint: 'Select one or any combination of classes for which the homework will be created.',
    ...
    visibleStudent: 'Allow student visibility after publication',
    visibleParent: 'Allow parent visibility after publication is complete',
    requireSubmission: 'Student submission required',
    preview: 'Classes and teachers',
    previewHint: 'Every class must have exactly one main teacher for the subject before creation.',
    teacherReady: 'Ready',
    ...
    fixAssignments: 'Complete teacher assignments before creating the homework.',
    invalidForm: 'Check the homework details before creating it.',
    notSelected: 'Not selected',
    selectedSections: 'Target classes',
    readyTeachers: 'Ready teachers',
    readyToSend: 'Homework is ready to be created.',
    completeRequired: 'Complete required fields and teacher assignments to enable creation.',
    stepOne: '1',
    stepTwo: '2',
  },
  es: {
    title: 'Añadir tarea',
    subtitle: 'Elige las clases y la materia, redacta la tarea y revisa las opciones antes de crear el borrador.',
    back: 'Volver a tareas',
    audience: 'Clases destinatarias',
    ...
    sections: 'Clases',
    sectionsHint: 'Selecciona libremente una o varias clases para las que se creará la tarea.',
    ...
    visibleStudent: 'Permitir visibilidad al alumno después de la publicación',
    visibleParent: 'Permitir visibilidad a la familia después de completar la publicación',
    requireSubmission: 'Requiere entrega del alumno',
    preview: 'Clases y profesores',
    previewHint: 'Cada clase debe tener exactamente un profesor principal para la materia antes de crear la tarea.',
    teacherReady: 'Listo',
    ...
    fixAssignments: 'Completa las asignaciones de profesores antes de crear la tarea.',
    invalidForm: 'Revisa los datos de la tarea antes de crearla.',
    notSelected: 'Sin seleccionar',
    selectedSections: 'Clases destinatarias',
    readyTeachers: 'Profesores listos',
    readyToSend: 'La tarea está lista para crearse.',
    completeRequired: 'Completa los campos obligatorios y las asignaciones para habilitar la creación.',
    stepOne: '1',
    stepTwo: '2',
  },
} as const;
