...
const COPY = {
  ar: {
    ...
    subtitle:
      'أدر هوية المؤسسة، بنيتها الأكاديمية، وإعدادات المستندات من مساحة واحدة واضحة وآمنة.',
  ...
  fr: {
    ...
    subtitle:
      "Gérez l’identité de l’établissement, sa structure académique et les paramètres des documents depuis un espace unique.",
